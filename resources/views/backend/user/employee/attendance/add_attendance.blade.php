                                    ...
                                    <div class="intro-x cursor-pointer box relative flex items-center p-5 " style="width:800px;margin-left:12%;">
                                        ...
                                        <div class="ml-2 overflow-hidden">
                                            <div class="flex items-center">
                                                ...
                                                <input type="text"  name="emp_id" class="rounded-full border-primary">
                                                 </a>

                                                 <a href="javascript:;" class="font-medium text-secondary ml-3">Name:
                                                <input type="text"  name="name" class="rounded-full border-primary">
                                                 </a>
                                            ...
                                            <div class="flex flex-col sm:flex-row mt-2 ml-6">
                                              <div class="form-check mr-2">
                                                        <input name="status"  class="form-check-input " type="radio" value="Present" checked="checked">
                                                         <label class="form-check-label text-success" >Present</label>
                                                         </div>

                                                        <div class="form-check mr-2 mt-2 sm:mt-0">
                                                        <input name="status"  class="form-check-input" type="radio" value="Leave">
                                         ...
                                         Arrival Time:
                                            <input type="time" name="arrival_time" class="form-control border-black" >

                                         </div>

                                          <div class="flex items-center justify-center absolute top-6 right-0 text-xs rounded-full text-pending mt-4 mr-2">
                                          Leave Time:
                                            <input type="time" name="leave_time" class="form-control border-black" >
                                         </div>
