        ...
        <div class="intro-y box p-5 mt-5">
            <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                    ...
                    <div class="intro-x relative mr-3 sm:mr-6">
                        <div class="search hidden sm:block">
                            <input id="search2" type="text" class="search__input form-control border-transparent" placeholder="Search...">
                            <i data-lucide="search" class="search__icon dark:text-slate-500"></i>
                        </div>
                        <a class="notification sm:hidden" href=""> <i data-lucide="search" class="notification__icon dark:text-slate-500"></i> </a>
            ...
            <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                <table class="table table-report sm:mt-2">
                    ...
                    <tr class="text-primary">
                        ...
                        <th class="text-center whitespace-nowrap text-success">Present</th>
                        <th class="text-center whitespace-nowrap text-warning">Leave</th>
                        <th class="text-center whitespace-nowrap text-danger">Absent</th>
                    ...
                    @foreach ( $allData as $key=> $value)
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="text-center">{{$value->present}}</td>
                            <td class="text-center">{{$value->leaves}}</td>
                            <td class="text-center">{{$value->absent}}</td>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3 text-warning" href="{{route('attendance.details',$value->date)}}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="check-square" data-lucide="check-square" class="lucide lucide-check-square w-4 h-4 mr-1"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"></path></svg> Details </a>
