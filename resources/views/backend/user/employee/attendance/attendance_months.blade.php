...
<div class="content">
             ...
             <!-- BEGIN: Content -->
                ...
                <div class="grid grid-cols-2 gap-6 mt-5 flex items-center">
                            <a href="javascript:;" data-tw-toggle= "modal" data-tw-target="#overlapping-modal" >
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">

                                        <div   class="report-box zoom-in">
                                            <div class="box p-5">
                                                <div class="flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="file-text" data-lucide="file-text" class="lucide lucide-file-text report-box__icon text-success"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"></path></svg>
                                                    <div class="ml-auto">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6">View Attendance</div>
                                                <div class="text-base text-slate-500 mt-1">All Employee Attendance</div>
                                            </div>
                                        </div>
                                     ...
                                     <a href="{{route('attendance.add')}}"  data-tw-toggle= "modal" data-tw-target="#overlapping-modal-preview" >
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                <div class="flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="edit" data-lucide="edit" class="lucide lucide-user-edit report-box__icon text-pending"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
                                                    <div class="ml-auto">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6">Add Attendance</div>
                                                <div class="text-base text-slate-500 mt-1">Add Employee Attendance</div>
    ...
    <!-- BEGIN: Modal Content -->
    <div id="overlapping-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body px-24 py-10">
                    <div class="text-center">
                        <div class="mb-5 text-pending">Select Method for View Attendance</div>
                        <!-- BEGIN: Overlapping Modal Toggle -->
                        <a href="{{ route('attendanceAll.view') }}" data-tw-toggle="modal" data-tw-target="#next-overlapping-modal-preview" class="btn btn-facebook  "> <i data-lucide="plus-square" class="w-4 h-4 mr-2"></i> All Attendance List</a> <!-- END: Overlapping Modal Toggle -->
                        <a href="{{ route('attendance.view') }}" data-tw-toggle="modal" data-tw-target="#next-overlapping-modal-preview" class="btn btn-linkedin   ml-3"> <i data-lucide="pocket" class="w-4 h-4 mr-2"></i> Attendance Group by Date</a> <!-- END: Overlapping Modal Toggle -->
                    </div>
