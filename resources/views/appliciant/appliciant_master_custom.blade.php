...
<head>
    ...
    <style>
        ...
        #popup-modal, #defaultModal, #delete-modal, #edit-modal, #view-modal, #editdesignationModal, #small-modal, #add-modal, #available_test_delete-modal, #available_test_add-modal,#available_test_edit-modal, #schedule_edit-modal, #schedule_add-modal, #mark_delete-modal, #season-modal, #confirm_reject_modal, #confirm_approve_modal, #show_applied-modal{
...
<div class="flex">
    ...
    <!-- BEGIN: Side Menu -->
    @include('appliciant.body.sidebar')
    <!-- END: Side Menu -->
