                        ...
                        <div class="grid grid-cols-12 gap-6 mt-2">
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y" >
                                <div class="report-box zoom-in" >
                                    <a href="{{route('usertransportrequest')}}">
                                        <div class="box p-5" >
                                            <div class="flex" >
                                                ...
                                                <div class="ml-auto">
{{--                                                    <div class="report-box__indicator bg-success tooltip cursor-pointer" title="33% Higher than last month">  <i data-lucide="fall-outlined" class="w-4 h-4 ml-0.5"></i> </div>--}}
                                                </div>
                                            </div>
...
{{--                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">--}}
{{--                                <div class="report-box zoom-in">--}}
{{--                                    <a href="{{route('userrequestfurniture')}}">--}}
{{--                                        <div class="box p-5">--}}
{{--                                            <div class="flex">--}}
{{--                                                <iconify-icon icon="twemoji:chair" style="color: purple;" width="80" height="80"></iconify-icon>                                                                                           <div class="ml-auto">--}}
{{--                                                    <div class="report-box__indicator bg-danger tooltip cursor-pointer" title="2% Lower than last month"> 2% <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <div class="text-3xl font-medium leading-8 mt-6">{{$countfurniture}}</div>--}}
...
{{--                                                    <div class="report-box__indicator bg-success tooltip cursor-pointer" title="12% Higher than last month"> 12% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>--}}
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="{{route('userrequestinsurance')}}">
                                        <div class="box p-5">
                                            <div class="flex">
...
{{--                                                    <div class="report-box__indicator bg-success tooltip cursor-pointer" title="22% Higher than last month"> 22% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>--}}
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="{{route('userrequestpromotion')}}">
                                    <div class="box p-5">
                                        <div class="flex">
...
{{--                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">--}}
{{--                                <div class="report-box zoom-in">--}}
{{--                                    <a href="{{route('userrequestincrements')}}">--}}
{{--                                    <div class="box p-5">--}}
{{--                                        <div class="flex">--}}
{{--                                            <iconify-icon icon="bi:graph-up-arrow" style="color: green;" width="80" height="80"></iconify-icon>                                            <div class="ml-auto">--}}
{{--                                                <div class="report-box__indicator bg-success tooltip cursor-pointer" title="22% Higher than last month"> 22% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="text-3xl font-medium leading-8 mt-6">{{$countincrement}}</div>--}}
