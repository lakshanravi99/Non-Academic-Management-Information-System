            ...
            <div class="intro-y box mt-3 " >
                ...
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400 ">
                    <h2 class="font-medium text-base mr-auto">
                        Edit Service Details (University/Company)
                    </h2>
                    <a href="{{route('UserRequestmodule')}}">
                        <input type="button" class="btn btn-primary shadow-md mr-2"  value="Finish" style="margin-left: 900px">
                    </a>
                </div>
                <div id="horizontal-form" class="p-3">
                    <div class="preview">
                        ...
                        <form method="POST" action={{route('storePromoRequestService')}}>
                            @csrf
