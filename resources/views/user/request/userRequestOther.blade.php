        ...
        <div class="top-bar">
            ...
            <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Other Request </li>
                </ol>
            </nav>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
                    ...
                    <div class="preview">
                        ...
                        <form method="POST" action="storeRequest">
                            ...
                            <div class="form-inline mt-5">
                                ...
                                <input type="hidden" name="reqtype" value="Other">
                            </div>
                    ...
                    <div class="preview">
                        ...
                        <form method="POST" action="storeRequest">
                            ...
                            <div class="form-inline mt-5">
                                ...
                                <input type="hidden" name="reqtype" value="Insurance">
                            </div>
