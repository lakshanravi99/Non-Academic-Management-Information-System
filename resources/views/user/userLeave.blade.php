                ...
                <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 mt-2">
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-2">
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y" >
                                ...
                                <div class="report-box zoom-in" >
                                    ...
                                    <div class="box p-5" >
                                        ...
                                        <div class="text-3xl font-medium leading-8 mt-6">{{$count->short_leave}}</div>
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="{{route('usercasualleave')}}">
                                    <div class="box p-5">
                                        <div class="flex">
                                            <span class="iconify" data-icon="bx:book-alt"></span>                                            <div class="ml-auto">
                                            </div>
                                        </div>
                                        <div class="text-3xl font-medium leading-8 mt-6">{{$count->casual_leave}}</div>
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="{{route('usermedicalleave')}}">
                                    <div class="box p-5">
                                        <div class="flex">
                                            <span class="iconify" data-icon="fa-solid:briefcase-medical"></span>                                            <div class="ml-auto">
                                            </div>
                                        </div>
                                        <div class="text-3xl font-medium leading-8 mt-6">{{$count->medical_leave}}</div>
                                        <div class="text-base text-slate-500 mt-1">Sick Leave</div>
                                    </div>
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="tiny-slider" id="important-notes">
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="font-medium flex mt-5">
                                                ...
                                                </a>                                                <button type="button" class="btn btn-outline-secondary py-1 px-2 ml-auto ml-auto">Dismiss</button>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
