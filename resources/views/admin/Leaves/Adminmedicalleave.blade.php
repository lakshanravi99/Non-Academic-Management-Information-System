    ...
    <div class="content">
        ...
        <div class="top-bar">
            ...
            <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="adminleavemode">Admin Leave </a></li>
                    <li class="breadcrumb-item active" aria-current="page">Medical Leave</li>
                </ol>
            </nav>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
            ...
            <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                <table class="table table-report sm:mt-2">
                    ...
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Place</th>
                        <th class="text-center whitespace-nowrap">Status</th>
{{--                        <th class="text-center whitespace-nowrap">Initiate Date</th>--}}
                        <th class="text-center whitespace-nowrap"> Start Day</th>
                        <th class="text-center whitespace-nowrap"> End Day</th>
