...
{{--                        <th class="text-center whitespace-nowrap">Initiate Date</th>--}}
                        <th class="text-center whitespace-nowrap">Leave Start Time</th>
                        <th class="text-center whitespace-nowrap">Leave End Time</th>
