        ...
        <div class="top-bar">
            ...
            <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">HalfDay Leave</li>
                </ol>
            </nav>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
...
{{--                        <th class="text-center whitespace-nowrap">Initiate Date</th>--}}
                        <th class="text-center whitespace-nowrap">Leave Start Day</th>
                        <th class="text-center whitespace-nowrap">Leave End Day</th>
