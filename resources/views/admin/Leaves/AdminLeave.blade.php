                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y" >
                                    <div class="report-box zoom-in" >
                                        <a href="{{route('adminusershortleave')}}">
                                            <div class="box p-5" style="background-color: red">
                                                <div class="flex" >
                                                    <span class="iconify" data-icon="ant-design:fall-outlined"></span>                                            <div class="ml-auto">
                                                    </div>
                                                </div>
                                                <div class="text-3xl font-medium leading-8 mt-6">{{$shortleavecount}}</div>
                                                <div class="text-base text-slate-500 mt-1" >Short Leave</div>
                                            </div>
                                        </a>
                                    </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="{{route('admincasualleave')}}">
                                        <div class="box p-5" style="background-color: #a390f0">
                                            <div class="flex">
                                                <span class="iconify" data-icon="bx:book-alt"></span>                                            <div class="ml-auto">
                                                </div>
                                            </div>
                                            <div class="text-3xl font-medium leading-8 mt-6">{{$casualleavecount}}</div>
                                            <div class="text-base text-slate-500 mt-1">Casual Leave</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="{{route('adminhalfdayleave')}}">
                                        <div class="box p-5" style="background-color: #edd415">
                                            <div class="flex">
                                                <span class="iconify" data-icon="bi:circle-half"></span>                                            <div class="ml-auto">
                                                </div>
                                            </div>
                                            <div class="text-3xl font-medium leading-8 mt-6">{{$halfleavecount}}</div>
                                            <div class="text-base text-slate-500 mt-1">Half Day</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="{{route('adminmedicalleave')}}">
                                        <div class="box p-5" style="background-color: #15ed4f">
                                            <div class="flex">
                                                <span class="iconify" data-icon="fa-solid:briefcase-medical"></span>                                            <div class="ml-auto">
                                                </div>
                                            </div>
                                            <div class="text-3xl font-medium leading-8 mt-6">{{$medicaleavecount}}</div>
                                            <div class="text-base text-slate-500 mt-1">Medical Leave</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
