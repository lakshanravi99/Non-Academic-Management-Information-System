    ...
    <div class="content">
        ...
        <div class="top-bar">
            ...
            <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Employee Add</a></li>
            ...
            <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                        <div class="border-2 border-dashed dark:border-darkmode-400 rounded-md pt-4">
                            <div class="fallback">
                                <input name="picture" type="file" id="xxfg" onchange="readURL(this);">
                            </div>
                            <script>
                    ...
                    <div class="ml-5">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="00{{$lastempid}}" name="emp_id"  aria-label="Email" aria-describedby="input-group-email">
                        </div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px"><label for="regular-form-1" class="form-label">
                                2.First Name</label> <input name="fname" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px"><label for="regular-form-1" class="form-label">
                                3.Middle Name</label>
                            <input name="mname" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px"><label for="regular-form-1" class="form-label">
                                4.Last Name</label>
                            <input name="lname" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                            <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px"><label for="regular-form-1" class="form-label">
                ...
                <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                    ...
                    <div class="flex flex-col justify-center items-center lg:items-start mt-4" >
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px"><label for="regular-form-1" class="form-label">7.Gender</label>
                        ...
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px"><label for="regular-form-1" class="form-label">9.Civil Status</label>
                            ...
                            <select name="civil_status" class="form-select mt-2 sm:mr-2" aria-label="Default select example">
                        ...
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            ...
                            <input name="current_postal_address" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">11.Permanent Postal Address</label>
                            <input name="permanent_postal_address" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">12.Current Mobile</label>
                            <input name="current_mobile" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">13.Permanent Mobile</label>
                            <input name="permanent_mobile" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">14.Police Division</label>
                            <input name="police_division" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">15.Email</label>
                            <input required name="email" id="regular-form-1" type="email" class="form-control" placeholder="example@gmail.com"></div>
                    </div>
                </div>
                ...
                <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                    ...
                    <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                        ...
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            ...
                            <input required name="dob" id="regular-form-1" type="date" class="form-control" placeholder="Input text"></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">17.Age as Closing Date</label>
                            <br>
                            <input name="age_as_at_closing_date" id="regular-form-1" type="number" class="form-control" >
...
{{--                            <input id="regular-form-1" type="number" class="form-control" style="width: 100px;">--}}
                        ...
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            ...
                            <input name="citizenship" id="regular-form-1" type="text" class="form-control" placeholder=""></div>

                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">19.NIC No. </label>
                            <input name="nic" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">20.Driving Licen No.</label>
                            <input name="driving_licen_no" id="regular-form-1" type="text" class="form-control" placeholder=""></div>
                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">21.Driving Licen Issuing Date</label>
                            <input name="driving_licen_issuing_date" id="regular-form-1" type="date" class="form-control" placeholder=""></div>

                        <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg" style="width: 300px">
                            <label for="regular-form-1" class="form-label">20.Salary</label>
                            <div class="input-group mt-2">
                                <input name="salary" type="text" class="form-control" placeholder="" aria-label="Price" aria-describedby="input-group-price">
                    ...
                    <input type="submit" class="btn-danger-soft" value="Submit">
                </div>
    </form>
