                ...
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y" >
                    ...
                    <div   class="report-box zoom-in" >
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">View Employees</div>
                            <div class="text-base text-slate-500 mt-1">View All Employees in the Faculty</div>
                        </div>
                    </div>
                ...
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">Add Employees</div>
                            <div class="text-base text-slate-500 mt-1">Add Employees in the Faculty</div>
                        </div>
                    </div>
