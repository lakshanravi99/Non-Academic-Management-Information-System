        ...
        <div class="intro-y box p-5 mt-5">
            ...
            @if($errors->any())
                ...
                <table class="table table-report sm:mt-2">
                    <thead>
                    <tr>
                        <th class="whitespace-nowrap">Post ID</th>
                        ...
                        <th class="text-center whitespace-nowrap">React Count</th>
                        <th class="text-center whitespace-nowrap">Comment Count</th>
                    ...
                    @foreach ($data as $req )
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{$req->emp_id}}</a>
                            </td>

                            <td class="text-center">{{$req->fname}}</td>
                            ...
                            <div class="intro-x w-8 h-8 image-fit">
                                <img alt="" data-action="zoom" class="rounded-full border border-white zoom-in tooltip" src="{{$req->picture}}" title="Brad Pitt">
                            </div>
                            </td>
                            <td class="text-center">{{$req->react_count}}</td>
                            <td class="text-center">{{$req->comment_count}}</td>
