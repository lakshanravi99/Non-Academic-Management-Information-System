        ...
        <div class="intro-y box p-5 mt-5">
            ...
            @if($errors->any())
                ...
                <table class="table table-report sm:mt-2">
                    <thead>
                    <tr>
                        <th class="whitespace-nowrap">Comment ID</th>
                        <th class="whitespace-nowrap">Post ID</th>
                        <th class="text-center whitespace-nowrap">Text</th>
                    ...
                    @foreach ($data as $req )
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{$req->post_id}}</a>
                            </td>

                            <td class="text-center">{{$req->text}}</td>
