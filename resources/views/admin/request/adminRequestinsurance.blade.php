                ...
                <table class="table table-report sm:mt-2">
                    ...
                    @foreach ($data as $req )
                        ...
                        <tr class="intro-x" >
                            ...
                            <td class="w-40">
                                <a href="{{ url('insurancedetails/' . $req->emp_id) }}">
