                    ...
                    <div class="preview">
                            ...
                            <div class="sm:ml-20 sm:pl-5 mt-5">
                                <div class="flex justify-center items-center" >
                                    <b>Head of Department: {{session('place')}}</b>
                                    </div>
                                <hr><br>

                                <div class="flex justify-center items-center" >
                                    {{--                                                        <a href="{{ url('adminRequestMoreBTN/' . $req->id.'/'.$req->emp_id) }}"> <input type="button" value="More" class="btn btn-primary w-full sm:w-16"></a>--}}
                                    <a class="flex items-center text-success mr-3" href="{{ url('approvetransportrequest/' . $req->id.'/'.'hod') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="check-square" data-lucide="check-square" class="lucide lucide-check-square w-4 h-4 mr-1"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"></path></line><line x1="14" y1="11" x2="14" y2="17"></line></svg> Approve </a>
                                    <a class="flex items-center text-danger" href="{{ url('rejectTransportrequest/' . $req->id.'/'.'hod') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="trash-2" data-lucide="trash-2" class="lucide lucide-trash-2 w-4 h-4 mr-1"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg> Reject </a>
                                ...
                                <div class="form-inline mt-5" style="width: 90px">
                                    <label for="horizontal-form-1" class="form-label sm:w-20">Reason</label>
                                </div>
                                <form method="post" action="{{route('storeheadReason')}}">
                                    @csrf
                                    <div class="form-inline mt-5" style="width: 100%">
                                        <input type="hidden" value="{{$req->id}}" name="reqid">
                                        <input  type="text" name="hodreason" class="form-control"  rows="2" required >
                            ...
                            <div class="sm:ml-20 sm:pl-5 mt-5 ">
                                ...
                                <div class="flex justify-center items-center" >
                                    {{--                                                        <a href="{{ url('adminRequestMoreBTN/' . $req->id.'/'.$req->emp_id) }}"> <input type="button" value="More" class="btn btn-primary w-full sm:w-16"></a>--}}
                                    <a class="flex items-center text-success mr-3" href="{{ url('approvetransportrequest/' . $req->id.'/'.'dean') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="check-square" data-lucide="check-square" class="lucide lucide-check-square w-4 h-4 mr-1"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"></path></line><line x1="14" y1="11" x2="14" y2="17"></line></svg> Approve </a>
                                    <a class="flex items-center text-danger" href="{{ url('rejectTransportrequest/' . $req->id.'/'.'dean') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="trash-2" data-lucide="trash-2" class="lucide lucide-trash-2 w-4 h-4 mr-1"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg> Reject </a>
                                    <a class="flex items-center text-danger" href="{{ url('canceltransportrequest/' . $req->id) }}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="trash-2" data-lucide="trash-2" class="lucide lucide-trash-2 w-4 h-4 mr-1"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg> Cancel </a>
                                </div>
                                <div class="form-inline mt-5" style="width: 90px">
                                    <label for="horizontal-form-1" class="form-label sm:w-20">Reason</label>
                                </div>
                                <form method="post" action="{{route('storedeanReason')}}">
                                    @csrf
                                <div class="form-inline mt-5" style="width: 100%">
                                    <input type="hidden" value="{{$req->id}}" name="reqid">
                                    <input  type="text" name="deanreason" class="form-control"  rows="2" required >
                                    <button class="hidden" type="submit">submit</button>
