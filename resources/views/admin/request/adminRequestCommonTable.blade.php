            ...
            <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                <table class="table table-report sm:mt-2">
                    ...
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Expect Position</th>
                    ...
                    @foreach ($data as $req )
                        ...
                        <tr class="intro-x" >
                            ...
                            <td class="text">{{$req->expect_post}}</td>
                            ...
                            <td class="">
                            <a href="{{ url('promodetails/' . $req->emp_id) }}">
                            ...
                            <td>
                                <a href="{{ url('deleterequestpromotion/' . $req->id) }}">
                                    <input type="Remove" value="Remove" class="btn btn-danger shadow-md "   style="width: 35%;">
                                </a>
                            </td>
