    ...
    <div class="content">
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            <h2 class="text-lg font-medium mr-auto">
                {{session('adminreqtitle')}} Request List
            </h2>
                ...
                <table class="table table-report sm:mt-2">
                    ...
                    @foreach ($data as $req )
                        ...
                        <tr class="intro-x" >
                            ...
                            <td class="w-40">
                                <a href="{{ url('transferdetails/' . $req->emp_id) }}">
