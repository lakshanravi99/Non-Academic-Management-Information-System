                                ...
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        <div class="flex">
                                            ...
                                            <iconify-icon icon="bxs:user" style="color: darkblue;" width="30" height="30"></iconify-icon>                                            <div class="ml-auto">
                                                <div class="report-box__indicator bg-success tooltip cursor-pointer" title="33% Higher than last month"> 33% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                        </div>
                                        <div class="text-3xl font-medium leading-8 mt-6">{{$allusercount}}</div>
                                        <div class="text-base text-slate-500 mt-1">System Users</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        <div class="flex">
                                            <iconify-icon icon="emojione:white-heavy-check-mark" style="color: darkblue;" width="30" height="30"></iconify-icon>                                            <div class="ml-auto">
                                                <div class="report-box__indicator bg-danger tooltip cursor-pointer" title="2% Lower than last month"> 2% <i data-lucide="chevron-down" class="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                        </div>
                                        <div class="text-3xl font-medium leading-8 mt-6">{{$todaypresent}}</div>
                                        <div class="text-base text-slate-500 mt-1">Today Present</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        <div class="flex">
                                            <iconify-icon icon="bi:file-earmark-lock-fill" style="color: orange;" width="30" height="30"></iconify-icon>                                            <div class="ml-auto">
                                                <div class="report-box__indicator bg-success tooltip cursor-pointer" title="12% Higher than last month"> 12% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                        </div>
                                        <div class="text-3xl font-medium leading-8 mt-6">{{$personalfilescount}}</div>
                                        <div class="text-base text-slate-500 mt-1">Personal Files</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <div class="box p-5">
                                        ...
                                        <div class="text-3xl font-medium leading-8 mt-6">{{$applicantcount}}</div>
                                        <div class="text-base text-slate-500 mt-1">Today Applications</div>
                                    </div>
                                </div>
                            </div>
                        </div>
