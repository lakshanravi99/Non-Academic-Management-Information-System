    ...
    <div class="content">
        ...
        <div class="top-bar">
            ...
            <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('personalfilee')}}">Notice</a></li>
                ...
                <div class="intro-y box p-5 mt-6">
                    <div class="mt-1">
                        <div class="overflow-auto p-3 mb-3 mb-md-0 mr-md-3 bg-light" style="max-width: 660px; max-height: 510px;">
                            <strong>
                                <a  href="{{route('noticee') }}" class="flex items-center px-3 py-2 rounded-md bg-primary text-white font-medium"> <i class="w-4 h-4 mr-2" data-lucide="user"></i> All </a>
                            </strong>
                            <strong>
                                @foreach($usertypes as $e)
                                    <a  href="{{ url('selectnoticebytype/'.$e->usertype ) }}" class="flex items-center px-3 py-2 rounded-md bg-primary text-white font-medium"> <i class="w-4 h-4 mr-2" data-lucide="user"></i> {{$e->usertype}} </a>
                                @endforeach
                            </strong>
            ...
            <div class="col-span-12 lg:col-span-9 2xl:col-span-10">
                ...
                <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                    <div class="w-full sm:w-auto flex">
                        <button onclick="uploadform()" class="btn btn-primary shadow-md mr-2">Add New Notice</button>
                    ...
                    @foreach($fileselect as $f)
                        <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 2xl:col-span-2">
                            <div  class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in " >
                                ...
                                <a href="{{ url('readNOTICEs/'.$f->file)}}" target="blank" class="w-3/5 file__icon file__icon--file mx-auto">
                                    <div class="file__icon__file-name">Notice</div>
                                </a>
                                <a href="" class="block font-medium mt-4 text-center truncate">{{$f->file}}</a>
                                <div  class="w-full truncate text-slate-500 mt-0.5">{{$f->text}}</div>
                                <div class="absolute top-0 right-0 mr-2 mt-3 dropdown ml-auto">
                                    ...
                                    <div class="dropdown-menu w-40">
                                        <ul class="dropdown-content">
                                            <li>
                                                <a href="{{ url('deleteNOTICE/'.$f->id)}}" class="dropdown-item"> <i data-lucide="trash" class="w-4 h-4 mr-2"></i> Delete </a>
                                            </li>
                                            <li>
                                                <a href="{{ url('notice/'.$f->file)}}" download="{{ url('notice/'.$f->file)}}" class="dropdown-item"> <i data-lucide="trash" class="w-4 h-4 mr-2" ></i> Download </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="form hidden" id="addform">
                    <form method="post" action="{{route('uploadnewnotice')}}" enctype="multipart/form-data">
                        @csrf
                        <a href="" class="ml-auto flex items-center text-primary" > <i data-lucide="refresh-ccw" class="w-4 h-4 mr-3"></i> Back </a>
                        <input type="hidden" name="empid" value="{{session('emp_id')}}">
