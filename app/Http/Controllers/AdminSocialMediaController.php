...
class AdminSocialMediaController extends Controller
{
    ...
    function loadcomments(){
        ...
        return view('admin.adminsocialmediacomments', compact('data','usertypesfresh'));
    }
...
//--------------------delete---------------------------------------------------------------
    function deletepost($postid){
        if (session('emp_id')){
            ...
            return Redirect::back()->withErrors(['sucess' => 'Successfully Deleted Post,']);
        }

        return Redirect::back()->withErrors(['msg' => 'Failure: Try Again Delete Post']);
    ...
    function deletecomment($postid){
        if (session('emp_id')){
            ...
            return Redirect::back()->withErrors(['sucess' => 'Successfully Deleted Comment,']);
        }else{
            return Redirect::back()->withErrors(['msg' => 'Failure: Try Again Delete Comment']);
        }
